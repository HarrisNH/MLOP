...
@pytest.mark.skipif(
    not os.path.exists(
        "/Users/harrishadzimahovic/Desktop/DTU/5/Machine Learning Operations/MLOPS/data/corruptedmnist/train_images_0.pt"
    ),
    reason="Data files not found",
)
def test_data():
    train_data, test_data = corrupt_mnist()
    assert len(train_data) == 30000, "Expected 30000 samples in train data"
