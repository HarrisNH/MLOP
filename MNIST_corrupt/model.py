...
class MyAwesomeModel(LightningModule):
    ...
    def train_dataloader(self):
        ...
        train_dataloader = torch.utils.data.DataLoader(train_set, batch_size=self.hparams["batch_size"],num_workers=7,persistent_workers=True)
        return train_dataloader
    
    def test_dataloader(self):
        _, test_set = corrupt_mnist()
        test_dataloader = torch.utils.data.DataLoader(test_set, batch_size=self.hparams["batch_size"],num_workers=7,persistent_workers=True)
